  ...
  return (
    <div className="relative">
      ...
      <section className="relative h-screen bg-[#2C2D4F] text-white flex items-center  flex-row justify-center md:justify-between p-10 lg:p-28 xl:p-36 2xl:px-44 flex-wrap">
        ...
        <div
          className="download-cv w-64 h-64 lg:w-72 lg:h-72 xl:w-80 xl:h-80 2xl:w-96 2xl:h-96 text-white cursor-pointer"
          onClick={handleDownload}
        >
          <span className="z-10 text-[#220a3d] font-bold text-2xl duration-1000">
            &lt;Download CV /&gt;
          </span>
        </div>
      </section>
